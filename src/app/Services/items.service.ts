...
export class ItemsService {
  ...
  constructor() { 
    ...
    this.listOfProducts.push(new Item(242, 'Žigulinis', 'Lager hop beer', 4.2,'../../assets/Images/zigulinis.jpg', 'A simple lager beer of one hop flower and one malt',[], 3.7));
    ...
    this.listOfProducts.push(new Item(36, 'Žigulinis', 'Lager hop beer', 4.2,'../../assets/Images/zigulinis.jpg', 'A simple lager beer of one hop flower and one malt',[], 3.7));
